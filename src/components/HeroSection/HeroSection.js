        ...
        <div className="row">
          <div className="col-md-12 col-xl-12">
            ...
            <ul>
              ...
              <li className="p-1 color-white">No Coding Background Required</li>
              <li className="p-1 color-white">Pay only when you get placed*</li>
              <li className="p-1 color-white">
